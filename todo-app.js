(function() {
    ...
    //     let contant = document.getElementsByClassName('list-group')
    //     console.log(contant);
    //         console.log(JSON.stringify(contant));
    //         // localStorage.setItem('list-group', JSON.stringify(contant));
    //     };
    ...
    function createTodoApp(container, title = 'Список дел', obj) {
        ...
        let storageItemArray = localStorage.getItem('item') ? JSON.parse(localStorage.getItem('item')) : []

        localStorage.setItem('item', JSON.stringify(storageItemArray));
